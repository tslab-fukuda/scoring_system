...
urlpatterns = [
    ...
    path('study_analytics/', views.help_ticket_analytics, name='study_analytics'),
    path('study_analytics/api/', views.help_ticket_analytics_api, name='study_analytics_api'),
